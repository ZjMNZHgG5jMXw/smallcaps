...
usage = do
  ...
  putStrLn    ""
  putStrLn    " % smallcaps isolation starts with <state>"
  putStrLn    "    isolated macros and environments start in <state>"
  putStrLn    "    with new sentence:  first letter capitalised"
  putStrLn    "    within sentence:    transform first letter to small caps"
  putStrLn    "    without action:     no transformations"
  putStrLn    ""
